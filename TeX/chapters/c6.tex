...
\begin{xiti}
	...
	\item 标准钟 $A$，$B$ 静止于某惯性系中的同一空间点上。$A$ 钟从某时刻开始以速率 $u=0.6c$ 匀速直线飞出，$\SI{2}{\second}$（根据$A$ 钟）后以 $u=0.6c$ 匀速直线返航。已知分手时两钟皆指零。(1) 求重逢时两钟的读数；(2) 当 $A$ 钟指 $\SI{3}{\second}$ 时看见 $B$ 钟指多少？
		...
		\begin{jie}
			\begin{enumerate}
				\item 由 $u=0.6c$ 知 $\displaystyle \gamma=\frac{5}{4}$，故 $\Delta\tau_\text{A}=\SI{2}{\second}$ 对应 $\displaystyle \Delta t=5/2 \unit{\second}$，由于 $B$ 钟在惯性系中静止，重逢时 $\tau_\text{B}=\SI{5}{\second}$，$\tau_{\text{A}}=\SI{4}{\second}$。
