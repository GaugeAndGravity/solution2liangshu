...
\begin{xiti}
	...
	\begin{jie}
		...
		与愚蠢的人类相比，麦酱可以更快地计算（并且不会抄错分量\raisebox{-1bp}{\includegraphics[height=12bp]{wulian}}）。将以下函数定义写入一个Mathematica程序包文件(.m)或者放在笔记本文件的开头：
...
RiemannTensor['\mmacs g\_','\mmacs x\_']:=Table[riemanntensor['\mmacs g','\mmacs x','\mmab i','\mmab j','\mmab k','\mmab l'],
	...
	\begin{jie}
		...
		\begin{figure}[htb]
			\centering
			\includegraphics[width=0.8\textwidth]{chapters/2}
	...
	\begin{figure}[htb]
		\centering
		\includegraphics[width=0.8\textwidth]{chapters/3}
