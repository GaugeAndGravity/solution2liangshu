...
\ifwindows\newfontfamily\codefont{DejaVuSansMono Nerd Font}\fi
\iflinux\newfontfamily\codefont{DejaVuSansMono}\fi
...
\newcommand{\hj}[2][-1bp]{\raisebox{#1}{\includegraphics[height=#2 bp]{pictures/hj}}}
\newcommand{\wl}[2][-1bp]{\raisebox{#1}{\includegraphics[height=#2 bp]{pictures/wulian}}}
